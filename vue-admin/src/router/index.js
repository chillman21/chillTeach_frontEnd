...
export const constantRoutes = [
...

  {
    ...
    children: [{
      ...
      meta: { title: 'chillTeach后台首页', icon: 'dashboard' }
    }]
  }]
/**
 * 动态路由
    ...
    children: [
      {
        ...
        meta: { title: '讲师列表', icon: 'teacher2' }
      },
      {
        path: 'save',
        name: '添加讲师',
        component: () => import('@/views/edu/teacher/save'),
        meta: { title: '添加讲师', icon: 'teacher-add' }
      },
      {
        path: 'edit/:id',
        name: '编辑讲师',
    ...
    children: [
      {
        ...
        meta: { title: '课程列表', icon: 'manage-list' }
      },
      {
        path: 'info',
        name: '课程发布',
        component: () => import('@/views/edu/course/info'),
        meta: { title: '课程发布', icon: 'course' }
      },
      {
        path: 'info/:id',
