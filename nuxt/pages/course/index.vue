          ...
          <section class="fl">
            <ol class="js-tap clearfix">
              <li :class="{'current bg-orange':defaultSort!=''}">
                <a title="默认" href="javascript:void(0);" @click="searchDefault()">
                  默认&nbsp;
                </a>
              </li>
              <li :class="{'current bg-orange':buyCountSort!=''}">
                <a title="关注度" href="javascript:void(0);" @click="searchBuyCount()">
                  关注度&nbsp;
              ...
              <li v-for="item in data.items" :key="item.id">
                <div class="cc-l-wrap">
                  ...
                  <section class="mt10 hLh20 of">
                    ...
                    <span class="fr jgTag bg-blue" v-if="Number(item.price)>0">
