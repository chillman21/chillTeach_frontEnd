        ...
        <aside class="c-attr-wrap">
          <section class="ml20 mr15">
            ...
            <section class="c-attr-jg">
              ...
              >￥{{ courseInfo.price }}</b>
              <b v-else class="c-yellow" style="font-size:24px;">免费</b>
            </section>
            ...
            <section v-if="hasBought||Number(courseInfo.price)===0" class="c-attr-mt">
              <a href="#chapter" title="立即观看" class="comm-btn c-btn-3">立即观看</a>
              <i v-if="hasBought" class="free-icon vam mr10">您已购买</i>
            </section>
                        ...
                        <ul id="chapter">
                          ...
                          >
                            ...
                            <ol class="lh-menu-ol" style="display: block;">
                              ...
                              >
                                <div v-if="video.videoSourceId.length<1||video.videoSourceId==null">
                                  <a>
                                    <span class="fr">
                                      <i class="er-icon vam mr10">视频未上传</i>
                                    </span>
                                ...
                                <div v-else>
                                  <a v-if="video.isFree == true" :href="'/player/'+video.videoSourceId" target="_blank">
                                    <span  class="fr">
                                  ...
                                  <a v-if="video.isFree==false&&hasBought==false">
                                    <span  class="fr">
                                      <i class="er-icon vam mr10">购买后观看</i>
                                    </span>
                                    <em class="lh-menu-i-2 icon16 mr5">&nbsp;</em>
                                    {{ video.title }}
                                  </a>
                                  <a v-if="video.isFree==false&&hasBought==true" :href="'/player/'+video.videoSourceId" target="_blank">
                                    <span  class="fr">
                                      <i class="free-icon vam mr10">已购买</i>
                                    </span>
                                    <em class="lh-menu-i-2 icon16 mr5">&nbsp;</em>
                                    {{ video.title }}
                                  </a>
    ...
    initCourseInfo() {
      course.getCourseInfo(this.courseId).then(response => {
        (this.courseInfo = response.data.data.courseWebVo),
          ...
          (this.hasBought = response.data.data.hasBoughtCourse);
      });
    },
    //生成订单
    createOrder() {
      var userInfo = cookie.get("chill_ucenter");
